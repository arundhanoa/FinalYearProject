    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line_of_service', models.CharField(choices=[('Audit', 'Audit'), ('Tax', 'Tax'), ('Consulting', 'Consulting'), ('Deals', 'Deals'), ('Internal Firm Services', 'Internal Firm Services')], max_length=50)),
                ...
                ('home_office', models.CharField(choices=[('London', 'London'), ('Birmingham', 'Birmingham'), ('Manchester', 'Manchester'), ('Leeds', 'Leeds'), ('Bristol', 'Bristol')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_images', to='main.event')),
            ],
        ),
        migrations.AddField(
            model_name='event',
